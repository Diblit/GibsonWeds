...
function InitActivityTable() {
    ...
    dtActivityList = $('#tblActivityList').dataTable({
        ...
        "bJQueryUI": false,
        "bAutoWidth": false,
        "sAjaxSource": base_url + '/api/admin/activity/list',
        ...
        'bSortable': false,
        'aTargets': [-1],
        "aoColumns": [{ "sTitle": "Guest Name", "mDataProp": "GuestName", "sWidth": "50%" },
            { "sTitle": "Activity", "mDataProp": "ActivityName", "sWidth": "25%" }
        ...
        "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) {
            ...
            //actionHtml += ' <a href="javascript:void(0);" onclick="DeleteGuest(' + aData["activityID"] + ')" data-toggle="tooltip" title="Delete" data-placement="left" data-original-title="Delete" class="btn btn-default btn-sm btn-danger fa fa-times"></a>';
            //// }
            ////else {
...
//    cancelEdit();
//    var ActivityCategory = dtActivityList.fnGetData(row);
